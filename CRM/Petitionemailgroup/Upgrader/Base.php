 ...
 */
class CRM_Petitionemailgroup_Upgrader_Base {
  ...
  static public function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Petitionemailgroup_Upgrader(
   ...
   *
   * @code
   * CRM_Petitionemailgroup_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
